...
def create_json_file(docker_image, script_filename, mod_data):
    ...
    "image": docker_image,
    "type": "docker",
    "command-line": f"python3 /app/{script_filename} --project #PROJECT# --subject #SUBJECT# --session #SESSION# --scan #SCAN#",
    ...
    "xnat": [
        {
            ...
            "derived-inputs": [
                ...
                },
                {
                    ...
                    "type": "string",
                    "required": True,
                    "provides-value-for-command-input": "scan",
                    "user-settable": False,
                    "derived-from-wrapper-input": "scan",
                    "derived-from-xnat-object-property": "id"
                }
