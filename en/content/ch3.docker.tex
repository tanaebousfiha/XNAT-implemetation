...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=1.1\textwidth]{en/content/mockup4.png}
  \caption{GUI Mockup 4 for Docker Container Automation in XNAT}
\end{figure}

In the figure 3.11 displays the last screen in the workflow. In this step, a summary of the previous steps are being generated. With the aim to porvid the user with a confirmation that the implementation and deployment have been completed successfully.