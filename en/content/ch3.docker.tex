...
As we can see in the figure 3.7 we have a simple presentation of what could the mockup of the automatization of the Docker Container look like. The advantages of this exmenple is that is extremly userfirendly and the user has a full vieuw of what is going on in the GUI.
