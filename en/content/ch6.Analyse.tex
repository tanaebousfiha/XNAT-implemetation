...
- The pipeline has to be  removed or disabled after the running, to prevent users from running this pipeline in the future\footnote{\url{https://wiki.xnat.org/documentation/adding-and-configuring-pipelines-for-your-project} last accessed 12.10.2025}.\\
- The pipeline is not a preferred way to launch jobs in XNAT\footnote{\url{https://wiki.xnat.org/xnat-tools/xnat-pipeline-engine-plugin} last accessed 12.10.2025}.
