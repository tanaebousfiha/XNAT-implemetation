...
With the aim of analyzing the Pipeline method more deeply, it is worth noting that XNAT provides several REST API endpoints for managing and running pipelines the most relevant endpoint for automation is \texttt{POST /pipelines/launch/{pipelineName}~\cite{pipelinerestapi}.
