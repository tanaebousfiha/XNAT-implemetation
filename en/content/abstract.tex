...
This work investigates the existing methods for integrating and deploying AI on biosignals within the Extensible Neuroimaging Archive Toolkit (XNAT), intending to recognize limitations, best practices, and opportunities for automation, as well as both generalization and application within the Somnolink project, considering sustainability aspects including the FAIR principles (Findable, Accessible, Interoperable, Reusable).
